...
public class Date {
	...
	public boolean dateExiste(int jour, int mois, int annee) {
		return(((mois==1 || mois==3 || mois==5 || mois==7 || mois==8 || mois==10 || mois==12) && (jour>0 && jour<=31))
				|| ((mois==4 || mois==6 || mois==9 || mois==11) && (jour>0 && jour<=30))
				|| (annee29J(annee) && mois==2 && (jour>0 && jour<=29))
				|| (!annee29J(annee) && mois==2 && (jour>0 && jour<=28)));
	}
