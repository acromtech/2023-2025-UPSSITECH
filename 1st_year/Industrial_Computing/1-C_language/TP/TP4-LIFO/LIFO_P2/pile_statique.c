#include <stdio.h>
#include "pile_statique.h" //EN REALITE C'EST LA PILE DYNAMIQUE MAIS C'EST LA SEULE MODIFICATION A FAIRE POUR QUE LE TRAIN FONCTIONNE AVEC UNE PILE DYNAMIQUE
